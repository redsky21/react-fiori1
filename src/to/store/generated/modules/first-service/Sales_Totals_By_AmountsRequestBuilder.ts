 ...
 */
export class Sales_Totals_By_AmountsRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Sales_Totals_By_Amounts<T>, T> {
  /**
  ...
  getByKey(orderId: DeserializedType<T, 'Edm.Int32'>, companyName: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<Sales_Totals_By_Amounts<T>, T> {
    return new GetByKeyRequestBuilder<Sales_Totals_By_Amounts<T>, T>(this.entityApi, {
      OrderID: orderId,
  ...
  getAll(): GetAllRequestBuilder<Sales_Totals_By_Amounts<T>, T> {
    return new GetAllRequestBuilder<Sales_Totals_By_Amounts<T>, T>(this.entityApi);
  }
  ...
  create(entity: Sales_Totals_By_Amounts<T>): CreateRequestBuilder<Sales_Totals_By_Amounts<T>, T> {
    return new CreateRequestBuilder<Sales_Totals_By_Amounts<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Sales_Totals_By_Amounts<T>): UpdateRequestBuilder<Sales_Totals_By_Amounts<T>, T> {
    return new UpdateRequestBuilder<Sales_Totals_By_Amounts<T>, T>(this.entityApi, entity);
  }
  ...
  delete(orderIdOrEntity: any, companyName?: string): DeleteRequestBuilder<Sales_Totals_By_Amounts<T>, T> {
    return new DeleteRequestBuilder<Sales_Totals_By_Amounts<T>, T>(this.entityApi, orderIdOrEntity instanceof Sales_Totals_By_Amounts ? orderIdOrEntity : {
