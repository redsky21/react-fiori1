 ...
 */
export declare class Orders_QriesRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Orders_Qries<T>, T> {
    /**
...
//# sourceMappingURL=Orders_QriesRequestBuilder.d.ts.map