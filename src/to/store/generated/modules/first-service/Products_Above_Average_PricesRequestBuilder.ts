 ...
 */
export class Products_Above_Average_PricesRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Products_Above_Average_Prices<T>, T> {
  /**
  ...
  getByKey(productName: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<Products_Above_Average_Prices<T>, T> {
    return new GetByKeyRequestBuilder<Products_Above_Average_Prices<T>, T>(this.entityApi, { ProductName: productName });
  }
  ...
  getAll(): GetAllRequestBuilder<Products_Above_Average_Prices<T>, T> {
    return new GetAllRequestBuilder<Products_Above_Average_Prices<T>, T>(this.entityApi);
  }
  ...
  create(entity: Products_Above_Average_Prices<T>): CreateRequestBuilder<Products_Above_Average_Prices<T>, T> {
    return new CreateRequestBuilder<Products_Above_Average_Prices<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Products_Above_Average_Prices<T>): UpdateRequestBuilder<Products_Above_Average_Prices<T>, T> {
    return new UpdateRequestBuilder<Products_Above_Average_Prices<T>, T>(this.entityApi, entity);
  }
  ...
  delete(productNameOrEntity: any): DeleteRequestBuilder<Products_Above_Average_Prices<T>, T> {
    return new DeleteRequestBuilder<Products_Above_Average_Prices<T>, T>(this.entityApi, productNameOrEntity instanceof Products_Above_Average_Prices ? productNameOrEntity : { ProductName: productNameOrEntity! });
  }
}
