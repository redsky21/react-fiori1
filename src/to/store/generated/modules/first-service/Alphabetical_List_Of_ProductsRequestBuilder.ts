 ...
 */
export class Alphabetical_List_Of_ProductsRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Alphabetical_List_Of_Products<T>, T> {
  /**
  ...
  getByKey(productId: DeserializedType<T, 'Edm.Int32'>, productName: DeserializedType<T, 'Edm.String'>, discontinued: DeserializedType<T, 'Edm.Boolean'>, categoryName: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<Alphabetical_List_Of_Products<T>, T> {
    return new GetByKeyRequestBuilder<Alphabetical_List_Of_Products<T>, T>(this.entityApi, {
      ProductID: productId,
  ...
  getAll(): GetAllRequestBuilder<Alphabetical_List_Of_Products<T>, T> {
    return new GetAllRequestBuilder<Alphabetical_List_Of_Products<T>, T>(this.entityApi);
  }
  ...
  create(entity: Alphabetical_List_Of_Products<T>): CreateRequestBuilder<Alphabetical_List_Of_Products<T>, T> {
    return new CreateRequestBuilder<Alphabetical_List_Of_Products<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Alphabetical_List_Of_Products<T>): UpdateRequestBuilder<Alphabetical_List_Of_Products<T>, T> {
    return new UpdateRequestBuilder<Alphabetical_List_Of_Products<T>, T>(this.entityApi, entity);
  }
  ...
  delete(productIdOrEntity: any, productName?: string, discontinued?: boolean, categoryName?: string): DeleteRequestBuilder<Alphabetical_List_Of_Products<T>, T> {
    return new DeleteRequestBuilder<Alphabetical_List_Of_Products<T>, T>(this.entityApi, productIdOrEntity instanceof Alphabetical_List_Of_Products ? productIdOrEntity : {
