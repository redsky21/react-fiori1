 ...
 */
export class Category_Sales_For_1997RequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Category_Sales_For_1997<T>, T> {
  /**
  ...
  getByKey(categoryName: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<Category_Sales_For_1997<T>, T> {
    return new GetByKeyRequestBuilder<Category_Sales_For_1997<T>, T>(this.entityApi, { CategoryName: categoryName });
  }
  ...
  getAll(): GetAllRequestBuilder<Category_Sales_For_1997<T>, T> {
    return new GetAllRequestBuilder<Category_Sales_For_1997<T>, T>(this.entityApi);
  }
  ...
  create(entity: Category_Sales_For_1997<T>): CreateRequestBuilder<Category_Sales_For_1997<T>, T> {
    return new CreateRequestBuilder<Category_Sales_For_1997<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Category_Sales_For_1997<T>): UpdateRequestBuilder<Category_Sales_For_1997<T>, T> {
    return new UpdateRequestBuilder<Category_Sales_For_1997<T>, T>(this.entityApi, entity);
  }
  ...
  delete(categoryNameOrEntity: any): DeleteRequestBuilder<Category_Sales_For_1997<T>, T> {
    return new DeleteRequestBuilder<Category_Sales_For_1997<T>, T>(this.entityApi, categoryNameOrEntity instanceof Category_Sales_For_1997 ? categoryNameOrEntity : { CategoryName: categoryNameOrEntity! });
  }
}
