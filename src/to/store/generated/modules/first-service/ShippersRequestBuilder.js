...
class ShippersRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     */
    getByKey(shipperId) {
        return new odata_v2_1.GetByKeyRequestBuilder(this.entityApi, { ShipperID: shipperId });
    }
    /**
    ...
    delete(shipperIdOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, shipperIdOrEntity instanceof Shippers_1.Shippers ? shipperIdOrEntity : { ShipperID: shipperIdOrEntity });
    }
}
