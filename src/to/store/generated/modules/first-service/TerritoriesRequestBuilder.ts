 ...
 */
export class TerritoriesRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Territories<T>, T> {
  /**
   ...
   */
  getByKey(territoryId: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<Territories<T>, T> {
    return new GetByKeyRequestBuilder<Territories<T>, T>(this.entityApi, { TerritoryID: territoryId });
  }
  ...
  delete(territoryIdOrEntity: any): DeleteRequestBuilder<Territories<T>, T> {
    return new DeleteRequestBuilder<Territories<T>, T>(this.entityApi, territoryIdOrEntity instanceof Territories ? territoryIdOrEntity : { TerritoryID: territoryIdOrEntity! });
  }
}
