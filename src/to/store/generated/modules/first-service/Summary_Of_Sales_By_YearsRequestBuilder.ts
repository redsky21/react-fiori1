 ...
 */
export class Summary_Of_Sales_By_YearsRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Summary_Of_Sales_By_Years<T>, T> {
  /**
  ...
  getByKey(orderId: DeserializedType<T, 'Edm.Int32'>): GetByKeyRequestBuilder<Summary_Of_Sales_By_Years<T>, T> {
    return new GetByKeyRequestBuilder<Summary_Of_Sales_By_Years<T>, T>(this.entityApi, { OrderID: orderId });
  }
  ...
  getAll(): GetAllRequestBuilder<Summary_Of_Sales_By_Years<T>, T> {
    return new GetAllRequestBuilder<Summary_Of_Sales_By_Years<T>, T>(this.entityApi);
  }
  ...
  create(entity: Summary_Of_Sales_By_Years<T>): CreateRequestBuilder<Summary_Of_Sales_By_Years<T>, T> {
    return new CreateRequestBuilder<Summary_Of_Sales_By_Years<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Summary_Of_Sales_By_Years<T>): UpdateRequestBuilder<Summary_Of_Sales_By_Years<T>, T> {
    return new UpdateRequestBuilder<Summary_Of_Sales_By_Years<T>, T>(this.entityApi, entity);
  }
  ...
  delete(orderIdOrEntity: any): DeleteRequestBuilder<Summary_Of_Sales_By_Years<T>, T> {
    return new DeleteRequestBuilder<Summary_Of_Sales_By_Years<T>, T>(this.entityApi, orderIdOrEntity instanceof Summary_Of_Sales_By_Years ? orderIdOrEntity : { OrderID: orderIdOrEntity! });
  }
}
