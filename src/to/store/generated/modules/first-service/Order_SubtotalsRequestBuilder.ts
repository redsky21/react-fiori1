 ...
 */
export class Order_SubtotalsRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Order_Subtotals<T>, T> {
  /**
  ...
  getByKey(orderId: DeserializedType<T, 'Edm.Int32'>): GetByKeyRequestBuilder<Order_Subtotals<T>, T> {
    return new GetByKeyRequestBuilder<Order_Subtotals<T>, T>(this.entityApi, { OrderID: orderId });
  }
  ...
  create(entity: Order_Subtotals<T>): CreateRequestBuilder<Order_Subtotals<T>, T> {
    return new CreateRequestBuilder<Order_Subtotals<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Order_Subtotals<T>): UpdateRequestBuilder<Order_Subtotals<T>, T> {
    return new UpdateRequestBuilder<Order_Subtotals<T>, T>(this.entityApi, entity);
  }
  ...
  delete(orderIdOrEntity: any): DeleteRequestBuilder<Order_Subtotals<T>, T> {
    return new DeleteRequestBuilder<Order_Subtotals<T>, T>(this.entityApi, orderIdOrEntity instanceof Order_Subtotals ? orderIdOrEntity : { OrderID: orderIdOrEntity! });
  }
}
