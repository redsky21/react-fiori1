 ...
 */
export class Sales_By_CategoriesRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Sales_By_Categories<T>, T> {
  /**
  ...
  getByKey(categoryId: DeserializedType<T, 'Edm.Int32'>, categoryName: DeserializedType<T, 'Edm.String'>, productName: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<Sales_By_Categories<T>, T> {
    return new GetByKeyRequestBuilder<Sales_By_Categories<T>, T>(this.entityApi, {
  ...
  create(entity: Sales_By_Categories<T>): CreateRequestBuilder<Sales_By_Categories<T>, T> {
    return new CreateRequestBuilder<Sales_By_Categories<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Sales_By_Categories<T>): UpdateRequestBuilder<Sales_By_Categories<T>, T> {
    return new UpdateRequestBuilder<Sales_By_Categories<T>, T>(this.entityApi, entity);
  }
  ...
  delete(categoryIdOrEntity: any, categoryName?: string, productName?: string): DeleteRequestBuilder<Sales_By_Categories<T>, T> {
    return new DeleteRequestBuilder<Sales_By_Categories<T>, T>(this.entityApi, categoryIdOrEntity instanceof Sales_By_Categories ? categoryIdOrEntity : {
