...
export class Summary_Of_Sales_By_QuartersApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  requestBuilder(): Summary_Of_Sales_By_QuartersRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof Summary_Of_Sales_By_Quarters, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(Summary_Of_Sales_By_Quarters, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    SHIPPED_DATE: OrderableEdmTypeField<Summary_Of_Sales_By_Quarters<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
ORDER_ID: OrderableEdmTypeField<Summary_Of_Sales_By_Quarters<DeSerializers>, DeSerializersT, 'Edm.Int32', false, true>,
SUBTOTAL: OrderableEdmTypeField<Summary_Of_Sales_By_Quarters<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
