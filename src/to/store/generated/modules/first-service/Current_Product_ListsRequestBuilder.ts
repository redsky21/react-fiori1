 ...
 */
export class Current_Product_ListsRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Current_Product_Lists<T>, T> {
  /**
  ...
  getByKey(productId: DeserializedType<T, 'Edm.Int32'>, productName: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<Current_Product_Lists<T>, T> {
    return new GetByKeyRequestBuilder<Current_Product_Lists<T>, T>(this.entityApi, {
      ProductID: productId,
  ...
  getAll(): GetAllRequestBuilder<Current_Product_Lists<T>, T> {
    return new GetAllRequestBuilder<Current_Product_Lists<T>, T>(this.entityApi);
  }
  ...
  create(entity: Current_Product_Lists<T>): CreateRequestBuilder<Current_Product_Lists<T>, T> {
    return new CreateRequestBuilder<Current_Product_Lists<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Current_Product_Lists<T>): UpdateRequestBuilder<Current_Product_Lists<T>, T> {
    return new UpdateRequestBuilder<Current_Product_Lists<T>, T>(this.entityApi, entity);
  }
  ...
  delete(productIdOrEntity: any, productName?: string): DeleteRequestBuilder<Current_Product_Lists<T>, T> {
    return new DeleteRequestBuilder<Current_Product_Lists<T>, T>(this.entityApi, productIdOrEntity instanceof Current_Product_Lists ? productIdOrEntity : {
