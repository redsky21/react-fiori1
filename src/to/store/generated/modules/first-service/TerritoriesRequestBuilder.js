 ...
 */
class TerritoriesRequestBuilder extends odata_v2_1.RequestBuilder {
    /**
    ...
    getByKey(territoryId) {
        return new odata_v2_1.GetByKeyRequestBuilder(this.entityApi, { TerritoryID: territoryId });
    }
    /**
    ...
    delete(territoryIdOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, territoryIdOrEntity instanceof Territories_1.Territories ? territoryIdOrEntity : { TerritoryID: territoryIdOrEntity });
    }
}
